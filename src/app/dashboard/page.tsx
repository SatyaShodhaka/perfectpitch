...
const FeaturesComponent: React.FC = () => {
  return (
    <div className="bg-main rounded-xl shadow-md overflow-hidden my-8">
      <div className="p-12">
        <FeatureItem title="Tailored Questions" description="Directly relevant questions based on your job role, company, and description." />
        <FeatureItem title="Voice Practice" description="Improve your delivery with voice-recording sessions, mimicking real interviews." />
        <FeatureItem title="Speech Analysis" description="Our speech-to-text feature transcribes your answers for thorough review." />
        <FeatureItem title="LLM Scoring" description="Get scored on relevancy and clarity with Large Language Model technology." />
        <FeatureItem title="Anywhere, Anytime" description="Practice on the go with our mobile-friendly platform." />
      </div>
    </div>
  );
};
